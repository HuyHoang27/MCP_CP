...
# ------------------------------------------------------------------ SideBar widgets
    ...
    sd_compents.create_mcp_prompts_widget()
# ------------------------------------------------------------------ Main Logic
...
# ------------------------------------------------------------------ handle question (if any text)
    if user_text or st.session_state.get("prompt"):
        user_text = user_text if user_text else st.session_state.get("prompt")
        st.session_state["prompt"] = ""  # Clear prompt after use
