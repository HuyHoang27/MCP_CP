...
async def get_prompt_from_client(client: MultiServerMCPClient, prompt_name: str, arguments: Optional[dict[str, Any]],  server_name: str= "MCP Server CSV") -> list[HumanMessage | AIMessage]:
    """Get prompt from the MCP client."""
    return await client.get_prompt(server_name, prompt_name, arguments)
